...
export class ProcessingHelper {
  ...
  public async processAudioBase64(data: string, mimeType: string, conversationContext: string = "") {
    // Directly use LLMHelper to analyze inline base64 audio with context
    return this.llmHelper.analyzeAudioFromBase64(data, mimeType, conversationContext);
  }
